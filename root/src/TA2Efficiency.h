...
#ifndef __TA2Efficiency_h__
#define __TA2Efficiency_h__
...
class TA2Efficiency : public TA2Physics {
...
//		TA2Particle** fPARTtaggphot;				// TA2Particle tagger photon
	...
	public:
		...
		TA2Efficiency( const char*, TA2Analysis* );
		virtual ~TA2Efficiency();
	...
	ClassDef(TA2Efficiency,1)
};

//-----------------------------------------------------------------------------
inline void TA2Efficiency::Sort2Photon()
{
...
inline void TA2Efficiency::SortNPhoton()
{
...
inline Double_t TA2Efficiency::Sqr( Double_t x)
{
	return( x*x);
}
...
inline void TA2Efficiency::MarkUndefined( Int_t jtagg )
{
...
inline void TA2Efficiency::MarkEndBuffer()
{
