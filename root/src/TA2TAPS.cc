  ...
  switch( key )
  {
   ...
   case ETAPSTof:
    ...
    if(fTapsTof > 0)
    {
        ...
        fProtonCut=(TCutG*)fCutFile->Get("CUTG");
        fCutFile->Close();
    }
...
void TA2TAPS::PostInit( )
{
  ...
  fTAGG = (TA2Tagger*)((TA2Analysis*)fParent)->GetChild("TAGG");   //tagger
  fLadder = (TA2Ladder*)((TA2Analysis*)fParent)->GetGrandChild("Ladder"); //ladder
